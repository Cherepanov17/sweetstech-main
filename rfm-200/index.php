...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) === 'xmlhttprequest')) {
    ...
    $transport = (new Swift_SmtpTransport('smtp.jino.ru', 465))
...
MESS;
    ...
    $clientText = <<<MESS
Dear <b>{$name}</b>,<br><br>
Thank You for contacting to our company. Quotation for full production line for cereal mass led by forming machine for cereal mass <b>RFM-200</b> please find enclosed. Forming machine {$prod} have working width 200 mm and capacity up to 5 400 bars/h. Also quotation have additional equipment for installing full complete producing line. Also we produce forming machine RFM with working width 200, 400, 600 mm. Diferent working width — different capacity. You can choose any equipment from quotation as single machine or as full line.<br><br>
...
<img src="https://sweetstech.com/RFM-200/assets/img/logo_mail.png" alt=""> <br><br><br>
We offer more details about the machines of our production:<br><br>
Forming machine for cereals bars RFM-400 <br>
...
MESS;
    ...
    $messageToClient = (new Swift_Message("Forming machine for cereal mass RFM."))
        ->setFrom([$from => $from])
        ->setTo([$email => $name])
...
<head>
    ...
    <script src="/rfm-200/js/bootstrap.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/owl.carousel.min.js"></script>
    <link rel="stylesheet" href="/rfm-200/css/landings.css">
</head>
<body>
        ...
        <div class="header-wrapper js-header-wrapper">
            <div class="logo">
                <a href="/" class="logo-link">
                    <img src="/rfm-200/assets/img/logo.png" alt="sweets technologies logo" class="logo-img">
                </a>
            </div>
        ...
        <div class="specifications-wrapper">
            ...
            <div class="specifications-slider_wrapper">
                <div class="specifications-slider owl-carousel owl-theme">
                    <div><img src="/rfm-200/assets/img/200/rfm200-1jpg.jpg" alt=""></div>
                    <div><img src="/rfm-200/assets/img/200/rfm200-2jpg.jpg" alt=""></div>
                    <div><img src="/rfm-200/assets/img/200/rfm200-3jpg.jpg" alt=""></div>
                </div>
            </div>
        </div>
    </section>
        ...
        <ul class="product-list">
            <li class="product-item animated-item js-animated-item">
                <div class="product-img_wrapper">
                    <img src="/rfm-200/assets/img/200/8r-png.png" alt="" class="product-img">
                </div>
            ...
            <li class="product-item animated-item js-animated-item">
                <div class="product-img_wrapper">
                    <img src="/rfm-200/assets/img/200/6r-png.png" alt="" class="product-img">
                </div>
                <div class="product-info">
            ...
            <li class="product-item animated-item js-animated-item">
                <div class="product-img_wrapper">
                    <img src="/rfm-200/assets/img/200/11r-png.png" alt="" class="product-img">
                </div>
                <div class="product-info">
            ...
            <li class="product-item animated-item js-animated-item">
                <div class="product-img_wrapper">
                    <img src="/rfm-200/assets/img/200/16r-png.png" alt="" class="product-img">
                </div>
                <div class="product-info">
    ...
    <h2 class="section-title process-title">The technological process of work the forming machine RFM-200</h2>
        <div class="line_wrapper">
            ...
            <div class="profile-wrapper fadeInRight">
                <div class="about">
                    <p class="about-txt">Forming machine for cereal mass RFM-200 is very easy to operate and service. You will no need large production areas and huge lines. Despite its small size, the forming machine RFM-200 has capacity up to 5 400 bars per hour, with a working width of 200 mm.</p>
...
<section class="photo" id="photo">
        ...
        <ul class="photo-wrapper">
            ...
            <li class="line-item animated-item js-animated-item">
                <div class="line-img-wrapper">
                    <img src="/rfm-200/assets/img/200/line/rfm200-1png.png" alt="" class="line-img">
                    <span></span>
                </div>
...
<script src="/rfm-200/js/landings.js"></script>

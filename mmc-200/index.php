...
<head>
    ...
    <title>AUTOMATIC FORMING MACHINE MMC-200 | Sweets Technologies Ltd.</title>
        ...
        <div class="specifications-wrapper">
            ...
            <div class="specifications-slider_wrapper">
                <div class="specifications-slider owl-carousel owl-theme">
                    <div><img src="/mmc-200/assets/img/200/mms200-1jpg.jpg" alt=""></div>
                    <div><img src="/mmc-200/assets/img/200/mms200-2jpg.jpg" alt=""></div>
                    <div><img src="/mmc-200/assets/img/200/mms200-3jpg.jpg" alt=""></div>
                </div>
            </div>
        </div>
    </section>
        ...
        <ul class="product-list">
            <li class="product-item animated-item js-animated-item">
                <div class="product-img_wrapper">
                    <img src="/mmc-200/assets/img/200/1-400png.png" alt="" class="product-img">
                </div>
            ...
            <li class="product-item animated-item js-animated-item">
                <div class="product-img_wrapper">
                    <img src="/mmc-200/assets/img/200/9-400png.png" alt="" class="product-img">
                </div>
                <div class="product-info">
            ...
            <li class="product-item animated-item js-animated-item">
                <div class="product-img_wrapper">
                    <img src="/mmc-200/assets/img/200/8-400png.png" alt="" class="product-img">
                </div>
                <div class="product-info">
            ...
            <li class="product-item animated-item js-animated-item">
                <div class="product-img_wrapper">
                    <img src="/mmc-200/assets/img/200/7-400png.png" alt="" class="product-img">
                </div>
                <div class="product-info">
        ...
        <ul class="photo-wrapper">
            <li class="line-item animated-item js-animated-item">
                <div class="line-img-wrapper">
                    <img src="/mmc-200/assets/img/200/line/liniy_4png.png" alt="" class="line-img">
                    <span></span>
                </div>
            ...
            <li class="line-item animated-item js-animated-item">
                <div class="line-img-wrapper">
                    <img src="/mmc-200/assets/img/200/line/mms200-1png.png" alt="" class="line-img">
                    <span></span>
                </div>
            ...
            <li class="line-item animated-item js-animated-item">
                <div class="line-img-wrapper">
                    <img src="/mmc-200/assets/img/200/line/liniy_3png.png" alt="" class="line-img">
                    <span></span>
                </div>
            ...
            <li class="line-item animated-item js-animated-item">
                <div class="line-img-wrapper">
                    <img src="/mmc-200/assets/img/200/line/liniy_2png.png" alt="" class="line-img">
                    <span></span>
                </div>
            ...
            <li class="line-item animated-item js-animated-item">
                <div class="line-img-wrapper">
                    <img src="/mmc-200/assets/img/200/line/liniy_1png.png" alt="" class="line-img">
                    <span></span>
                </div>
                ...
                <ul class="contacts-list">
                    <li class="contacts-item">
                        <h6>
                            ...
                            <span>RUSSIA, STAVROPOL REGION, KOCHUBEEV DISTRICT,
...
<div class="contacts-form_wrapper js-contacts-form_wrapper">
    <form action="/mmc-200/index.php" class="form" method="post" enctype="multipart/form-data">
        ...
        <p class="form-info">
            <input type="checkbox" class="form-accept js-form-accept" checked="checked" id="accept"
